...
8)  Hover around "Living" navigation bar and print all the items in console from one of it's sub categories
...
1) Properties File (Reading Data)
   ...
   * This file consists of  URL value and Environment value as local.

2) Excel File (Reading data)
    
   * (GiftCardInput.json)- This Excel file is present in      
   * This file consists of values to be entered in 'Gift Cards' form.These include values of
     -> Amount 
     -> Recipient's Name
     -> Recipient's Email
     -> Your Name
